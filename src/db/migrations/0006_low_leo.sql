...
--> statement-breakpoint
ALTER TABLE "messagev2" ALTER COLUMN "role" SET DATA TYPE message_role USING role::message_role;--> statement-breakpoint
ALTER TABLE "messagev2" ADD COLUMN "model_name" text;--> statement-breakpoint
DO $$ BEGIN
